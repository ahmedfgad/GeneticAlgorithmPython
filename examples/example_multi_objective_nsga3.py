...
This example uses NSGA-III. The only extra parameter compared to NSGA-II is
'nsga3_num_divisions', which is the number of divisions per objective axis
used to build the structured reference points (the 'p' parameter from
Deb & Jain 2014). The total number of reference points is C(M + p - 1, p)
