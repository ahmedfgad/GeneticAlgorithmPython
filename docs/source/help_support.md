...
If this is not a proper option for you, then check the [**Contact Us**](https://pygad.readthedocs.io/en/latest/help_support.html#contact-us) section for more contact details.
...
Also check the [**Contact Us**](https://pygad.readthedocs.io/en/latest/help_support.html#contact-us) section for more contact details.
