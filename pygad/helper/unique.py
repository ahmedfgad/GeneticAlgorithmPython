...
class Unique:
    ...
    def unpack_gene_space(self, num_values_from_range=100):
        ...
        For the infinite range of float values, a number of values equal to num_values_from_range is selected using the numpy.linspace() function.
        ...
        for space_idx, space in enumerate(gene_space_unpacked):
            ...
            elif type(space) in [list, tuple, numpy.ndarray]:
